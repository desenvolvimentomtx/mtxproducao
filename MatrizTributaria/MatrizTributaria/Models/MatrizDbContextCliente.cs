...
namespace MatrizTributaria.Models
{
    ...
    public class MatrizDbContextCliente : DbContext
    {

        public MatrizDbContextCliente() : base("name=MatrizDbContextCliente") { }
        ...
        //novas tabelas
        public virtual DbSet<Crt> Crts { get; set; }
        public virtual DbSet<RegimeTribuario> RegimesTribarios { get; set; }
