...
$(document).ready(function () {
    ...
    var btnVisualizarDadosTribNCM = document.getElementById("visualizarDadosTribNCM");
    ...
    var btnVisualizarDadosTribNCM_MTX = document.getElementById("visualizarDadosTribNCM_MTX");
    ...
    if (btnVisualizarDadosTribNCM) {
        //alterar selecionados
        btnVisualizarDadosTribNCM.addEventListener("click", function () {
            ...
            $.ajax(
                {
                    ...
                    success: function () {
                        ...
                        window.location.href = '/Tributacao/Detalhes?id=' + strDados;
    ...
    if (btnVisualizarDadosTribNCM_MTX) {
        //alterar selecionados
        btnVisualizarDadosTribNCM_MTX.addEventListener("click", function () {
            ...
            $.ajax(
                {
                    ...
                    success: function () {
                        ...
                        //mandar para alterar so o cest e o ncm
                        window.location.href = '/TributacaoMTX/Detalhes?id=' + strDados;
